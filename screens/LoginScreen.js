...
export default function LoginScreen({ navigation }) {
  ...
  const { loading, register, login } = useAuth(navigation);
    ...
    >
      <ScrollView contentContainerStyle={styles.scrollContent}>
        <View style={[styles.card, { backgroundColor: colors.card }]}>
          <View
            style={[styles.headerIcon, { backgroundColor: colors.headerBg + "20" }]}
          >
...
const styles = StyleSheet.create({
  ...
  input: { flex: 1, paddingVertical: 14, fontSize: 15, marginLeft: 10 },
  eyeBtn: { padding: 4 },
  button: {
    flexDirection: "row",
    paddingVertical: 16,
  ...
  toggleBtn: { paddingVertical: 10, alignItems: "center" },
